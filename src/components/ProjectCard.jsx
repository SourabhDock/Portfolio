...
function ProjectCard(props) {
  ...
  return (
    <div index={props.index} className=' w-[90%] lg:h-auto py-4 px- sm:p-8 rounded-2xl flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-12 bg-white'>
        ...
        <div className='sm:hidden w-[90%] gap-4 flex flex-col items-center justify-center'>
            <h2 className='text-2xl text-black text-center font-bold'>{props.Name}</h2>
            <a href={props.Link} target='blank'  className='w-full h-12 rounded-xl bg-[#052241] text-white font-semibold flex items-center justify-center gap-3'>Live Demo <BsArrowRight /></a>
