...
const HeroSection = () => {
  return (
    <div className='bg-home-background w-screen h-162.5 flex flex-col justify-evenly items-center px-10'>
            ...
            <div className='w-[90%] flex flex-col  items-center justify-center gap-4  '>
                ...
                <h1 className='font-Scoutieu text-5xl font-semibold text-[#052241]'> <span>Hello I'm</span> SOURABH</h1>
                <h2 className='font-Roboto text-sm font-semibold text-[#052241]'></h2>
                <p className='flex flex-col text-center text-xl  '>build modern, scalable and user friendly web <span>applications that solves real world problems and</span> <span>create meaningful digital Experiences.</span></p>
