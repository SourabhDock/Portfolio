...
const Support = () => {
    return (
        <div className='w-full h-auto flex items-center mt-12 overflow-hidden justify-center rounded-2xl'>
            <div className='w-11/12 h-auto flex justify-between py-4 px-8 sm:px-16 bg-linear-to-r from-[#45337F] to-showcase-bar rounded-2xl'>
                <div className='flex flex-col w-full sm:w-[40%] gap-3 items-start justify-center'>
                    <h2 className='text-3xl sm:text-4xl font-Comfortaa text-white font-bold'>
                        Let's Create
                    </h2>
                    <h2 className='text-3xl sm:text-4xl font-Comfortaa text-white font-bold'>Something Amazing</h2>
                ...
                <div className='relative sm:flex justify-center w-[40%] h-auto hidden '>
